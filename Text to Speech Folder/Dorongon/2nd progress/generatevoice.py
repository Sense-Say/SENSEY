...
phrases = {
    "startup": "System ready. Choose a mode.",
    "behavior_active": "Student Behavior mode is actived.",
    "blind_active": "Blind Navigation Mode is activated.",
    "standby": "System is on standby.",
    "shutdown": "System is shutting down",
    "stopping": "Stop the process."
}
