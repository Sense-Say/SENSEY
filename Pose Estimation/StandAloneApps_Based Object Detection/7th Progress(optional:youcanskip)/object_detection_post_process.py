...
def inference_result_handler(original_frame, infer_results, labels, config_data, tracker=None, vio_data=None, waypoints=None, nav_waypoints=None, depth_frame=None, state_text="IDLE"):
    ...
    if vio_data:
        ...
        if waypoints: draw_ar_elements(original_frame, waypoints, curr_pos, yaw, color=(0, 0, 255)) # Recording Red
        if nav_waypoints: draw_ar_elements(original_frame, nav_waypoints, curr_pos, yaw, color=(0, 255, 0)) # Nav Green
