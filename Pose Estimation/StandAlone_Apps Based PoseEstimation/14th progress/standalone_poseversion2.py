...
def run_pose_monitor():
    ...
    PIPER_CMD = f'echo "Student Monitoring Mode ready. Press Button to Monitor Student Behavior" | {PIPER_EXE} --model {PIPER_MODEL} --length_scale 1.5 --output-raw | aplay -r 22050 -f S16_LE -t raw'
