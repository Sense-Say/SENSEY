...
class StudentActionMonitor:
    def __init__(self):
        ...
        # --- TUNING PARAMETERS ---
        # 0.005 is good for Normalized coordinates (0.0 to 1.0)
        self.WALKING_THRESHOLD = 0.005   
    ...
    def get_action(self, keypoints, track_id, center_point):
        ...
        Input: 
            ...
            track_id: int
            center_point: (x, y) tuple
        Returns: 
            (Action String, Color Tuple)
        """
        ...
        # Check Left Arm (Y is smaller at the top of the screen)
        ...
        if track_id in self.history:
            ...
            # Check if enough time has passed (0.2 seconds) to calculate speed
            ...
            if time_diff > 0.2: 
                ...
                # If less than 0.2s, we don't update history yet, 
                # but we can return the previous state if you wanted to smooth it.
                # For now, we default to Standing until the timer hits.
                pass 
        else:
